...
public abstract class BetterEnchants extends Enchantment {
     ...
     * @param name
     */
    protected BetterEnchants(String name, int maxLevel) {
        super(toKey(name));
    ...
    public BetterEnchantmentTarget getCustomItemTarget() {
        return BetterEnchantmentTarget.BREAKABLE;
    }
    ...
    public Material enchantMaterial() {
        return BetterEnchantmentTargetMaterial.enchantMaterial();
    }
    ...
    public Set<Material> enchantMaterials() {
        return BetterEnchantmentTargetMaterial.enchantMaterials();
    }
